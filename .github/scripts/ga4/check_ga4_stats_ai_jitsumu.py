#!/usr/bin/env python3
"""
GA4(Google Analytics Data API)から、AI実務ナビ(ai-jitsumu-navi、
測定ID G-QSW29CYYNP)のPV・アクティブユーザー数等を取得する。
...
プロパティキャッシュのみ別ファイル(ga4_property_cache_ai_jitsumu.json)に
分けて、ふくおかポーカーナビ側のdaemon/キャッシュに影響を与えないようにしている。
...
TARGET_MEASUREMENT_ID = "G-QSW29CYYNP"
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
PROPERTY_CACHE_PATH = os.path.join(SCRIPT_DIR, "ga4_property_cache_ai_jitsumu.json")

SINCE_LAUNCH_DATE = "2026-07-17"
